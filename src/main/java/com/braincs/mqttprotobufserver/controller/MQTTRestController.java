...
public class MQTTRestController {
    ...
    public static String TOPIC_PANEL_ADD_FACE_RES = IP_PREFIX + CLIENTID + "/out/add_face";//add_face 返回主题
    ...
    public static String TOPIC_PANEL_SNAPSHOT = IP_PREFIX + CLIENTID + "/snapshot";//snapshot 主题
    public static String TOPIC_PANEL_SNAPSHOT_RES = IP_PREFIX + CLIENTID + "/snapshot/result";//snapshot result 主题
...
//        publisher.publishMessage("demoTopic2017", data);
        ...
        publisher.publishMessage(topic, "test");
        return "Success";
    }
}
